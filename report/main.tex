...
\begin{frame}{Summary of key findings}
  ...
  \parbox{\textwidth}{%
    ...
    \item Reaching 100\% CFE is possible but costly with existing renewable 
    and storage technologies, with costs increasing rapidly above 95\%.
    
    \item 100\% CFE could have a much smaller cost premium if long duration storage or 
    clean dispatchable technologies like advanced geothermal are available.
    
    \item 100\% CFE procurement leads to lower emissions for both the buyer and the system,
    as well as reducing the needs for flexibility in the rest of the system.
    
    \item 100\% CFE targets would create an early market for these advanced technologies,
