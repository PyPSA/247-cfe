...
\begin{frame}{Estimating the CFE score of the regional grid}
  ...
  \noindent\fbox{%
  \parbox{\textwidth}{%
  Thus, CFEt is the percentage of clean electricity in each MWh of imported 
  electricity from the grid to supply participating 24/7 loads in a given hour.
  }}
  %Generation by CFE resources contracted by 24/7 consumers is excluded from the grid supply.
  }
\end{frame}
