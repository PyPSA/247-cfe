...
\begin{frame}{Summary of key findings}
  ...
  \parbox{\textwidth}{%
    \begin{enumerate}
    \item Reaching carbon-free energy (CFE) for 80-90\% of the time 
...
\begin{frame}{The effects of moving to 2030}
  ...
  due to, e.g., economics of scale and incremental innovation, national 
  energy- and climate policies become more tight, some legacy power plants age 
  and leave the market. An overarching feature of the energy transition is
...
\begin{frame}{2030 scenario -- Ireland}
...
\begin{frame}{2030 scenario -- Germany}
...
\begin{frame}{2030 scenario -- Ireland \& Germany}
...
\begin{frame}{Sensitivity runs}
  ...
  \parbox{\textwidth}{%
  {\small
  (i) How do findings adjust with higher participation rates of C\&I consumers? 
  For this analysis, we assume that {\bf 25\%} of C\&I consumers in a selected region 
  ...
  mix in a procured portfolio; although impacts on the procurement cost, emissionality of the portfolio,
...
\begin{frame}{Conclusions}
  ...
  \noindent\fbox{%
  \parbox{\textwidth}{%
    {\bf Conclusion 1:} Reaching carbon-free energy (CFE) for 80-90\% of the time
    has \alert{comparable cost and system impact} to annually matching 100\% renewable energy. 
    A CFE target of 80-90\% can be met through a combination of wind, solar and batteries.
  }}
  ...
  \noindent\fbox{%
  \parbox{\textwidth}{%
    {\bf Conclusion 3:} 100\% 24/7~CFE procurement could have a \alert{much smaller cost premium}
    if long duration energy storage or 
    clean dispatchable technologies like advanced geothermal are available.
  }}
  ...
  \parbox{\textwidth}{%
    ...
    stimulating innovation and learning from which the \alert{whole electricity system would profit}.
   }}
