...
\begin{frame}{Introduction}
  ...
  \source{\href{https://sustainability.google/progress/energy/}{sustainability.google/progress/energy/.}}
  \end{columns}
...
\begin{frame}{Why is this important? 1/2}
  ...
  \begin{columns}[T]
    ...
    \source{\href{https://www.iea.org/reports/data-centres-and-data-transmission-networks}{IEA: Data Centres and Data Transmission Networks}}
    \end{columns}
...
\begin{frame}{Why is this important? 2/2}
  ...
  \begin{columns}[T]
    ...
    \source{\href{https://www.climateneutraldatacentre.net/signatories/}{climateneutraldatacentre.net/signatories/}}
    \end{columns}
...
{\footnotesize
  \begin{itemize}
    ...
    \item We build upon the mathematical model of 24/7 carbon-free energy procurement developed in the former work of authors: \hrefc{https://zenodo.org/record/7180097}{System-level impacts of 24/7 carbon-free electricity procurement in Europe} (October 2022)
