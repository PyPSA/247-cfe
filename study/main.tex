...
\begin{frame}{Isolating values of spatial and temporal load shifting (2)}
  ...
  \begin{itemize}
    ...
    % Shifting workloads across time enables \alert{execution of flexible loads in 'greener' times}, i.e., optimize consumption as function of the local grid's carbon intensity (CFE targets $<100\%$) facilitating \alert{better utilization of locally procured resources}
...
\begin{frame}{Isolating values of spatial and temporal load shifting (4)}
  ...
  \source{24/7 CFE 100\% -- palette~2 tech -- isolated shifts}
  }
