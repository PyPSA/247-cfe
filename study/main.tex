...
{\footnotesize
  \begin{itemize}
    ...
    \item In this study, we encode a set of new equations and routines, which allow for modelling \alert{spatial} (computing jobs migration) and \alert{temporal} (computing jobs scheduling) load flexibility provided by data centers.
...
\begin{frame}{Optimal procurement strategy as a function of load flexibility (1)}
  ...
  \source{24/7 CFE 100\% -- palette~1 tech -- spatial \& temporal shits}
\end{frame}
...
\begin{frame}{24/7~CFE costs as a function of load flexibility (1)}
  ...
  \vspace{0.1cm}
  \alert{Load shifting reduces the costs for 24/7 procurement in all locations}, and especially in locations where hourly matching with CFE is expensive (IE, DE). Further, flexibility evens out the average costs across locations, making 24/7~CFE more affordable in resource-constrained places.
...
\begin{frame}{Optimal procurement strategy as a function of load flexibility (2)}
  ...
  \source{24/7 CFE 98\% -- palette~1 tech -- spatial \& temporal shits}
  \end{frame}
...
\begin{frame}{Optimal procurement strategy as a function of load flexibility (3)}
  ...
  \source{24/7 CFE 100\% -- palette~2 tech -- spatial \& temporal shits}
\end{frame}
...
\begin{frame}{Summary on economic efficiency for space/time load shifting}
...
\begin{frame}{Isolating values of spatial and temporal load shifting (1)}
  ...
  \begin{columns}
    \begin{column}{7.5cm}
    \includegraphics[width=7.5cm]{../results/1H-IEDKDEFIPT-spatial/plots/2025/EU/p1/cfe100/ci_abs_costs.pdf}
    \end{column}
    
    \begin{column}{7.5cm}
    \includegraphics[width=7.5cm]{../results/1H-IEDKDEFIPT-temporal/plots/2025/EU/p1/cfe100/ci_abs_costs.pdf}
    \end{column}
  \end{columns}

  \source{24/7 CFE 100\% -- palette~1 tech -- spatial and/or temporal shits}
  }
  
\end{frame}


\begin{frame}{Isolating values of spatial and temporal load shifting (2)}
  ...
  \begin{columns}
    \begin{column}{7.5cm}
    \includegraphics[width=7.5cm]{../results/1H-IEDKDEFIPT-spatial/plots/2025/EU/p1/cfe98/ci_abs_costs.pdf}
    \end{column}
    
    \begin{column}{7.5cm}
    \includegraphics[width=7.5cm]{../results/1H-IEDKDEFIPT-temporal/plots/2025/EU/p1/cfe98/ci_abs_costs.pdf}
    \end{column}
  \end{columns}

  \source{24/7 CFE 98\% -- palette~1 tech -- spatial and/or temporal shits}
  }
  
\end{frame}


\begin{frame}{Isolating values of spatial and temporal load shifting (3)}
  ...
  \begin{columns}
    \begin{column}{7.5cm}
    \includegraphics[width=7.5cm]{../results/1H-IEDKDEFIPT-spatial/plots/2025/EU/p2/cfe100/ci_abs_costs.pdf}
    \end{column}
    
    \begin{column}{7.5cm}
    \includegraphics[width=7.5cm]{../results/1H-IEDKDEFIPT-temporal/plots/2025/EU/p2/cfe100/ci_abs_costs.pdf}
    \end{column}
  \end{columns}

  \source{24/7 CFE 100\% -- palette~2 tech -- spatial and/or temporal shits}
  }
...
\begin{frame}{Selected examples of load shifting time-series 1/n}
  ...
  \includegraphics[height=5.5cm]{../results/1H-IEDKDEFIPT-allflex/plots/2025/EU/p1/cfe100/heatmaps/40_spatial_shift_ireland.pdf}
  }
...
\begin{frame}{Selected examples of load shifting time-series 2/n}
  ...
  \includegraphics[height=5.5cm]{../results/1H-IEDKDEFIPT-allflex/plots/2025/EU/p1/cfe100/heatmaps/40_spatial_shift_germany.pdf}
  }
...
\begin{frame}{Selected examples of load shifting time-series 3/n}
  ...
  \includegraphics[height=5.5cm]{../results/1H-IEDKDEFIPT-allflex/plots/2025/EU/p1/cfe100/heatmaps/40_temporal_shift_ireland.pdf}
  }
...
\begin{frame}{Selected examples of load shifting time-series 4/n}
  ...
  \includegraphics[height=5.5cm]{../results/1H-IEDKDEFIPT-allflex/plots/2025/EU/p1/cfe98/heatmaps/40_temporal_shift_ireland.pdf}
  }
...
\begin{frame}{Selected examples of load shifting time-series 5/n}
  ...
  \includegraphics[height=5.5cm]{../results/1H-IEDKDEFIPT-allflex/plots/2025/EU/p2/cfe100/heatmaps/40_spatial_shift_ireland.pdf}
  }
...
\begin{frame}{Local zone emissions VS 24/7 costs}
...
{\footnotesize
   ...
   \noindent\fbox{%
   \parbox{\textwidth}{%
     {\bf Conclusion 5:} Space-time load-shifting flexibility also enables taking advantage of differences in local resources, harvesting renewable electrcity in the best locations and indirectly \alert{opening access to it for all locations}. When paired with long-duration energy storage, the efficiency gains of this effect are even larger.
   }}
